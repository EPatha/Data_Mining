...
def analyze_win_rate(df):
    ...
    # Debugging step: print the columns after merge to check the column names
    print("Columns after merge:")
    print(win_rate.columns)

    # Filter out openings where total games (for White and Black) are less than or equal to 40
    if 'total_games_white' in win_rate.columns and 'total_games_black' in win_rate.columns:
        win_rate = win_rate[(win_rate['total_games_white'] > 40) & (win_rate['total_games_black'] > 40)]
    else:
        print("Column names are not correct. Please check the merge.")
